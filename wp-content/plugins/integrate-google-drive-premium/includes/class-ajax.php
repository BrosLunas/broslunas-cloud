...
class Ajax {
	...
	public function __construct() {
		...
		add_action( 'wp_ajax_igd_get_shortcode_preview', [ $this, 'get_shortcode_preview' ] );
	...
	public function get_shortcode_preview() {
		// Check nonce
		if ( ! check_ajax_referer( 'igd', 'nonce', false ) ) {
			wp_send_json_error( __( 'Invalid request', 'integrate-google-drive' ) );
		}
		...
		// Check permission
		if ( ! igd_user_can_access( 'shortcode_builder' ) ) {
			wp_send_json_error( __( 'You do not have permission.', 'integrate-google-drive' ) );
		}
	...
	public function get_export_data() {
		...
		/*
		 * Check permission
		 * Check if the current user is allowed to access the settings
		 */
		if ( ! igd_user_can_access( 'settings' ) ) {
			wp_send_json_error( __( 'You do not have permission to access this page', 'integrate-google-drive' ) );
		}
		...
		if ( igd_fs()->can_use_premium_code__premium_only() ) {
			if ( 'all' == $type || 'events' == $type ) {
				...
				$export_data['events'] = Statistics::instance()->get_events( '2022-01-01', date( 'Y-m-d' ), false );
			}
		}
	...
	public function delete_account() {
		...
		if ( ! check_ajax_referer( 'igd', 'nonce', false ) || ! igd_user_can_access( 'settings' ) ) {
			wp_send_json_error( __( 'You do not have permission to perform this action', 'integrate-google-drive' ) );
		}
	...
	public function get_files() {
		...
		// Check if the current user is allowed to fetch the files
		if ( ! igd_user_can_access( 'file_browser' ) && ! igd_user_can_access( 'shortcode_builder' ) ) {
			wp_send_json_error( __( 'You do not have permission to perform this action.', 'integrate-google-drive' ) );
		}
	...
	public function search_files() {
		...
		// Check if the current user is allowed to search files
		if ( ! igd_user_can_access( 'file_browser' ) && ! igd_user_can_access( 'shortcode_builder' ) ) {
			wp_send_json_error( __( 'You do not have permission to perform this action.', 'integrate-google-drive' ) );
		}
		...
		$files = App::instance( $account_id )->get_search_files( $keyword, $folders, $sort, $full_text_search );
	...
	public function get_file() {
		...
		// Check if the current user is allowed to get file
		if ( ! igd_user_can_access( 'file_browser' ) ) {
			wp_send_json_error( __( 'You do not have permission to perform this action.', 'integrate-google-drive' ) );
		}
	...
	public function delete_files() {
		...
		// Check if the current user is allowed to delete files
		if ( ! igd_user_can_access( 'file_browser' ) ) {
			wp_send_json_error( __( 'You do not have permission to perform this action.', 'integrate-google-drive' ) );
		}
	...
	public function new_folder() {
		...
		// Check if the current user is allowed to create a new folder
		if ( ! igd_user_can_access( 'file_browser' ) ) {
			wp_send_json_error( __( 'You do not have permission to perform this action.', 'integrate-google-drive' ) );
		}
	...
	public function create_doc() {
		...
		// Check if the current user is allowed to create a new file
		if ( ! igd_user_can_access( 'file_browser' ) ) {
			wp_send_json_error( __( 'You do not have permission to perform this action.', 'integrate-google-drive' ) );
		}
		...
		try {
			...
			// Insert log
			do_action( 'igd_insert_log', 'create', $file['id'], $account_id );
	...
	public function copy_file() {
		...
		// Check if the current user is allowed to copy files
		if ( ! igd_user_can_access( 'file_browser' ) ) {
			wp_send_json_error( __( 'You do not have permission to perform this action.', 'integrate-google-drive' ) );
		}
	...
	public function move_file() {
		...
		// Check if the current user is allowed to move files
		if ( ! igd_user_can_access( 'file_browser' ) ) {
			wp_send_json_error( __( 'You do not have permission to perform this action.', 'integrate-google-drive' ) );
		}
	...
	public function rename_file() {
		...
		// Check if the current user is allowed to rename file
		if ( ! igd_user_can_access( 'file_browser' ) ) {
			wp_send_json_error( __( 'You do not have permission to perform this action.', 'integrate-google-drive' ) );
		}
	...
	public function preview() {
		...
		// Check if the current user is allowed to preview file
		if ( ! igd_user_can_access( 'file_browser' ) ) {
			wp_send_json_error( __( 'You do not have permission to perform this action.', 'integrate-google-drive' ) );
		}
	...
	public function get_share_link() {
		...
		// Check if the current user is allowed to share files
		if ( ! igd_user_can_access( 'file_browser' ) ) {
			wp_send_json_error( __( 'You do not have permission to perform this action.', 'integrate-google-drive' ) );
		}
		...
		// Insert log
		do_action( 'igd_insert_log', 'share', $file['id'], $file['accountId'] );
	...
	/**
	 * Check if the current user has permission to the file browser page, where they can upload files
	 *
	 * @return void
	 */
	...
	public function upload_post_process() {
		...
		do_action( 'igd_insert_log', 'upload', $formatted_file['id'], $account_id );
	...
	public function remove_upload_file() {
		...
		// Check if the current user is allowed to remove uploaded files
		if ( ! igd_user_can_access( 'file_browser' ) ) {
			wp_send_json_error( __( 'You do not have permission to perform this action.', 'integrate-google-drive' ) );
		}
	...
	/**
	 * Check if the current user has permission to the file browser page, where they can update file description
	 *
	 * @return void
	 */
	public function update_description() {
		...
		// Check if the current user is allowed to update the file description
		if ( ! igd_user_can_access( 'file_browser' ) ) {
			wp_send_json_error( __( 'You do not have permission to perform this action.', 'integrate-google-drive' ) );
		}
	...
	/**
	 * Check permission if the current user has access to file browser module where they can download files
	 *
	 * @return void
	 */
	...
	/**
	 * Check if the current user has access to file browser module where they can stream files
	 *
	 * @return void
	 */
	public function stream_content() {
		...
		do_action( 'igd_insert_log', 'stream', $file['id'], $account_id );

		Stream::instance( $file )->stream_content();
