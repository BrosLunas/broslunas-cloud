...
Effortlessly play Google Drive audio and video files in a single player with download restrictions using the Media Player Shortcode Module. Create custom playlists from selected folders and files, and embed the player anywhere with a shortcode.  🎬 [Watch Video](https://youtu.be/L_uAvKuIEL8)
...
Enable vendors to use Google Drive files for product images and downloadable products. Additionally, vendors can permit customers to upload files to Google Drive upon purchasing products. 🎬 [Watch Video](https://youtu.be/S7sc-qqEnUY)
